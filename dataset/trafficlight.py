...
class TrafficLight(Imdb):
    ...
    def __init__(self, image_set, year, devkit_path, shuffle=False, is_train=False, class_names=None,
            names='traffic.names', true_negative_images=False):
        super(TrafficLight, self).__init__('voc_' + year + '_' + image_set)
        self.image_set = image_set
        self.year = year
        self.devkit_path = devkit_path
        self.data_path = os.path.join(devkit_path, 'traffic_light')
        self.extension = '.jpg'
